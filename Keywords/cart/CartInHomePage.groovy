...
public class CartInHomePage {
	...
	public void verifyQuantityInCart() {
		...
		String tempTotalProduct = WebUI.getText(findTestObject('Object Repository/MyBag/span_13 items')).replaceAll('\\D', '')
	...
	public void verifyPriceInCart() {
		...
		String totalPriceWebElement= WebUI.getText(findTestObject('Object Repository/MyBag/span_TotalPrice'))

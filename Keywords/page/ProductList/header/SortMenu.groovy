...
public class SortMenu {
	...
	@Keyword
	public void clickSortMenuItem(String nameMenu) {
		...
		WebUI.waitForElementClickable(findTestObject('Object Repository/Product List Page (New)/Sort/div_Name_Decreasing',['name':nameMenu]), GlobalVariable.TimeOut)
		WebUI.click(findTestObject('Object Repository/Product List Page (New)/Sort/div_Name_Decreasing',['name':nameMenu]))
	}
}
